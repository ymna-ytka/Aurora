ServerEvents.recipes(event=>{
    ...
    event.remove( { id: "gtceu:packer/package_quartz_sand_small_dust" } )
    event.remove( { id: "gtceu:packer/package_quartz_sand_tiny_dust" } ) 
    ...
    event.remove( { output:'gtceu:coke_oven_brick' } )
