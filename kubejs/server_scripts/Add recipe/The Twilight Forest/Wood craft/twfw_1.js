ServerEvents.recipes( event=> {
    ...
    event.recipes.gtceu.assembler("twilight_oak_chest_boat_assemb")
    ...
    event.recipes.gtceu.cutter('twilight_oak_button_lubricant')
    ...
    event.recipes.gtceu.cutter('twilight_oak_button_dist_water')
    ...
    event.recipes.gtceu.cutter('twilight_oak_button_water')
    ...
    event.shaped("4x twilightforest:twilight_oak_stairs",
