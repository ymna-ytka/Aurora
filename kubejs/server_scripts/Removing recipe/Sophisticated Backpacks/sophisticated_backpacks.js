ServerEvents.recipes(event=>{
    ...
    event.remove( { output:"sophisticatedbackpacks:smoking_upgrade_from_smelting_upgrade" } ) 

    event.remove( { output:"sophisticatedbackpacks:smoking_upgrade" } ) 

    event.remove( { output:"sophisticatedbackpacks:blasting_upgrade_from_smelting_upgrade" } ) 
    ...
    event.remove( { output:"sophisticatedbackpacks:stack_upgrade_tier_1_from_starter" } ) 
